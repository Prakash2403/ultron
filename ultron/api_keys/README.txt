...
A folder where user will put all the files containing keys related to API.

Naming convention for files will be <application name>_keys. For example: twitter_keys
